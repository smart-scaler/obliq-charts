...
kubectl get pods -n avesha -l app.kubernetes.io/name=neo4j-mcp

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=neo4j-mcp

# Describe the deployment
kubectl describe deployment -n avesha neo4j-mcp
```
...
```bash
# This will remove all services including neo4j-mcp
...
helm install neo4j-mcp-test ./neo4j-mcp \
