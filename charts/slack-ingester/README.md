...
Slack integration for notifications and incident management
...
kubectl get pods -n avesha -l app.kubernetes.io/name=slack-ingester

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=slack-ingester

# Describe the deployment
kubectl describe deployment -n avesha slack-ingester
```
...
```bash
# This will remove all services including slack-ingester
...
helm install slack-ingester-test ./slack-ingester \
