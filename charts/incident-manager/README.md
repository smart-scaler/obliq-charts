...
kubectl get pods -n avesha -l app.kubernetes.io/name=incident-manager

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=incident-manager

# Describe the deployment
kubectl describe deployment -n avesha incident-manager
```
...
```bash
# This will remove all services including incident-manager
...
helm install incident-manager-test ./incident-manager \
