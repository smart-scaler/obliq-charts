...
Automated remediation workflows and response actions
...
kubectl get pods -n avesha -l app.kubernetes.io/name=auto-remediation

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=auto-remediation

# Describe the deployment
kubectl describe deployment -n avesha auto-remediation
```
...
```bash
# This will remove all services including auto-remediation
...
helm install auto-remediation-test ./auto-remediation \
