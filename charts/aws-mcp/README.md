...
AWS Model Context Protocol integration service
...
kubectl get pods -n avesha -l app.kubernetes.io/name=aws-mcp

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=aws-mcp

# Describe the deployment
kubectl describe deployment -n avesha aws-mcp
```
...
```bash
# This will remove all services including aws-mcp
...
helm install aws-mcp-test ./aws-mcp \
