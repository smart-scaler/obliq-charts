...
Loki log aggregation integration service
...
kubectl get pods -n avesha -l app.kubernetes.io/name=loki-mcp

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=loki-mcp

# Describe the deployment
kubectl describe deployment -n avesha loki-mcp
```
...
```bash
# This will remove all services including loki-mcp
...
helm install loki-mcp-test ./loki-mcp \
