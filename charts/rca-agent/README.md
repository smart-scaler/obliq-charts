...
Root cause analysis engine with AI-powered diagnostics
...
kubectl get pods -n avesha -l app.kubernetes.io/name=rca-agent

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=rca-agent

# Describe the deployment
kubectl describe deployment -n avesha rca-agent
```
...
```bash
# This will remove all services including rca-agent
...
helm install rca-agent-test ./rca-agent \
