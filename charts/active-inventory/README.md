...
Infrastructure inventory and asset management service
...
kubectl get pods -n avesha -l app.kubernetes.io/name=active-inventory

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=active-inventory

# Describe the deployment
kubectl describe deployment -n avesha active-inventory
```
...
```bash
# This will remove all services including active-inventory
...
helm install active-inventory-test ./active-inventory \
