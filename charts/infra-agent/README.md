...
Infrastructure monitoring and data collection agent
...
kubectl get pods -n avesha -l app.kubernetes.io/name=infra-agent

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=infra-agent

# Describe the deployment
kubectl describe deployment -n avesha infra-agent
```
...
```bash
# This will remove all services including infra-agent
...
helm install infra-agent-test ./infra-agent \
