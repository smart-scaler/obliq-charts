...
AWS CloudWatch metrics integration service
...
kubectl get pods -n avesha -l app.kubernetes.io/name=cloudwatch-mcp

# View service logs
kubectl logs -n avesha -l app.kubernetes.io/name=cloudwatch-mcp

# Describe the deployment
kubectl describe deployment -n avesha cloudwatch-mcp
```
...
```bash
# This will remove all services including cloudwatch-mcp
...
helm install cloudwatch-mcp-test ./cloudwatch-mcp \
